...
@Slf4j
@Service
public class ComtradeServiceImpl implements ComtradeService {
    ...
    @Autowired
    public ComtradeServiceImpl(MeasurementsRepository measurementsRepository, RmsFilterService filterService) {
